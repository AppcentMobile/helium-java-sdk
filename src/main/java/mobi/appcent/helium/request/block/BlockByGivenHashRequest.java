 ...
 */
public class BlockByGivenHashRequest extends BaseRequest {

    private final HeliumSdkClient client;
    private final String hash;

    public BlockByGivenHashRequest(HeliumSdkClient client, String hash) {
        this.client = client;
        this.hash = hash;
    }

    public BlockDescriptionResponse execute() throws ApiException {
        String path = UrlConstant.BLOCKS_PATH + "/hash/" + hash;
